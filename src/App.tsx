...
import HalvesQuartersEighthsPractise from "./pages/HalvesQuartersEighthsPractise.tsx";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/practise/halves-quarters-eighths" element={<HalvesQuartersEighthsPractise />} />
